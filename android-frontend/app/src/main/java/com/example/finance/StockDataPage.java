...
public class StockDataPage extends AppCompatActivity {
    ...
    private WebView nIncomeMap;
    private WebView totalRevenueMap;
    private WebView bpsMap;
    private WebView roeMap;
    ...
    private boolean isOtherWebInit = false;
    ...
    private void WebInit(WebView webView, String srcUrl) {
        WebSettings settings = webView.getSettings();
        webView.setWebViewClient(new WebViewClientKMap());
...
/*
        ...
        WebInit(webKMap, "file:///android_asset/ech.htm");
        nIncomeMap = (WebView) findViewById(R.id.n_income_webView);
        totalRevenueMap = (WebView) findViewById(R.id.total_revenue_webView);
        bpsMap = (WebView) findViewById(R.id.bps_webView);
        roeMap = (WebView) findViewById(R.id.roe_webView);
            ...
            public void onClick(View view) {
                ...
                if (!isOtherWebInit) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            WebInit(nIncomeMap, "file:///android_asset/stockGraph/n_income2.htm");
                            // WebInit(totalRevenueMap, "file:///android_asset/stockGraph/total_revenue.htm");
                            WebInit(bpsMap, "file:///android_asset/stockGraph/bps2.htm");
                            // WebInit(roeMap, "file:///android_asset/stockGraph/roe.htm");
                        }
                    });
                    isOtherWebInit = true;
                }
