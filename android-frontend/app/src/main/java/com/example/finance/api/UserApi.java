...
public class UserApi {
    ...
    static class ThreadUser extends Thread{
        ...
        public void run(){
            resStr = GetURLContent.RequestWithBody("http","10.0.2.2","9999","/sys/brosehistory/"+mapping,parameters,values);
    ...
    public static R<String> CheckLogin(String username, String password) throws IOException, InterruptedException {
        ...
        values.add(username);
        values.add(password);
        ThreadUser_2 tu=new ThreadUser_2(parameters,values,"login","POST");
        tu.start();
        while(tu.a==null){
            Thread.sleep(100);
        }
