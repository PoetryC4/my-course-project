...
def model_pipeline(config=None):
    with wandb.init(config=config):
        ...
        wandb.init(project="CNN_TRANSFORMER_hypersearch")
        hidden_size = wandb.config.hidden_size
        ffn_num_hiddens = wandb.config.ffn_num_hiddens
        mlp_hidden_size = wandb.config.mlp_hidden_size

        print(
            f'Start traing model with the setting hidden_size={hidden_size}, ffn_num_hiddens={ffn_num_hiddens},'
        ...
        for epoch in range(epochs):
            ...
            #     best_setting['hidden_size'], best_setting['ffn_num_hiddens'], best_setting[
            #         'mlp_hidden_size'] = \
...
if __name__ == '__main__':
    ...
    sweep_id = wandb.sweep(sweep_config, project='search_optimal_hyper')
